...
[![codecov](https://codecov.io/gh/poissonconsulting/newdata/graph/badge.svg?token=pJO8edj5Wu)](https://app.codecov.io/gh/poissonconsulting/newdata)
[![License:
...
- `new_data.length_out_lgl`, which is 2 by default, for logical vectors (values greater than 2 have no effect as a logical sequence is at most `c(FALSE, TRUE)`);
