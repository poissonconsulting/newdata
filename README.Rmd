...
The main idea is that most variables are held constant at a reference level while
the variables of interest vary across their range.
...
# generate a data frame for all combinations of Tree ranging across the values
# of age with circumference at the mean level.
